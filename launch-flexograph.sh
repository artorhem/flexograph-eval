...
if [ -z "$SERVICE_NAME" ]; then
  echo "Usage: $0 [--test] "
  echo "Example: $0 flexograph"
  echo "Example: $0 --test flexograph"
  echo "Available services: flexograph"
  exit 1
fi
...
docker run -d \
  ...
  -v /drives/flexograph/graph500_28:/db/graph500_28 \
  -v /drives/flexograph/uk-2007:/db/uk-2007 \
  -v /drives/golden_images/graph500_30/graph500_30:/db/graph500_30 \
  "$IMAGE_NAME" \
  /bin/bash -c "
